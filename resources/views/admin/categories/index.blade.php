        ...
        <div class="toolbar" >
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <a href="#" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_create_app"
                   id="kt_toolbar_primary_button">Create Category</a>
                <!--end::Button-->
            </div>
            <!--end::Container-->
        </div>
                        ...
                        <div class="table-responsive">
                            ...
                            <table id="example2"
                                ...
                                @forelse($categories as $category)
                                    <tr>
                                        <td class="text-dark text-center fw-bolder text-hover-primary fs-6">{{$category->name_en}}</td>
                                        <td class="text-dark text-center fw-bolder text-hover-primary fs-6">{{$category->name_ar}}</td>
                                        <td class="text-dark text-center fw-bolder text-hover-primary fs-6">
                                            <div class="w3-row-padding">
                                                <a href="{{asset('images/category-image/' . $category->image)}}"
                                                   target="_blank" class="w3-container w3-third" style="width: 100%">
                                                    <img src="{{asset('images/category-image/' . $category->image)}}"
                                                         onclick="onClick(this)" class="w3-hover-opacity" width="50"
                                                         height="50">
                                                </a>
                                            </div>
                                        </td>
                                        <td class="text-center" style="display: flex; justify-content: center; ">
                                            <a data-com_id="{{ $category->id }}"
                                               data-com_name_en="{{ $category->name_en }}"
                                               data-com_name_ar="{{ $category->name_ar }}"
                                    ...
                                    <div class="w-100">
                                        ...
                                        <div class="fv-row mb-10">
                                            ...
                                            <input type="text" class="form-control form-control-lg form-control-solid"
                                                   name="name_en" id="com_name_en" required/>
                                            <!--end::Input-->
                                        </div>
                                        ...
                                        <div class="fv-row mb-10">
                                            ...
                                            <!--begin::Input-->
                                            <input type="text" class="form-control form-control-lg form-control-solid"
                                                   name="name_ar" id="com_name_ar" required/>
                                            <!--end::Input-->
                                        </div>
                                        ...
                                        <div class="fv-row mb-10">
                                            ...
                                            <input type="file" class="form-control form-control-lg form-control-solid"
                                                   name="image" id="com_image" required/>
                                            <!--end::Input-->
                                        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body py-lg-10 px-lg-10">
                    ...
                    <div class="stepper stepper-pills stepper-column d-flex flex-column flex-xl-row flex-row-fluid"
                        ...
                        <div class="flex-row-fluid py-lg-5 px-lg-15">
                            <!--begin::Form-->
                            <form class="form" id="kt_modal_create_app_form" method="post" enctype="multipart/form-data"
...
@push('js')
    <script>
        $('#edit_app').on('show.bs.modal', function (event) {
            ...
            var com_name_en = button.data('com_name_en')
            var com_name_ar = button.data('com_name_ar')
            var modal = $(this)

            modal.find('.modal-body #com_id').val(com_id);
            modal.find('.modal-body #com_name_en').val(com_name_en);
            modal.find('.modal-body #com_name_ar').val(com_name_ar);
