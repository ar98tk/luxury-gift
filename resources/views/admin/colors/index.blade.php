        ...
        <div class="toolbar" >
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <a href="#" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_create_app"
                   id="kt_toolbar_primary_button">Create Color</a>
                <!--end::Button-->
            </div>
            <!--end::Container-->
        </div>
                        ...
                        <div class="table-responsive">
                            ...
                            <table id="example2"
                                ...
                                @forelse($colors as $color)
                                    <tr>
                                        <td class="text-dark text-center fw-bolder text-hover-primary fs-6">{{$color->name_en}}</td>
                                        <td class="text-dark text-center fw-bolder text-hover-primary fs-6">{{$color->name_ar}}</td>
                                        <td class="text-dark text-center fw-bolder text-hover-primary fs-6"> <button class="btn btn-sm" style="background-color: {{$color->code}}"></button> {{$color->code}}</td>
                                        <td class="text-center" style="display: flex; justify-content: center; ">
                                            <a data-com_id="{{ $color->id }}"
                                               data-com_name_en="{{ $color->name_en }}"
                                               data-com_name_ar="{{ $color->name_ar }}"
                                               data-com_code="{{ $color->code }}"
                                            ...
                                            <form method="POST" action="{{ route('colors.destroy', $color->id) }}">
                                                ...
                                                <button href="{{route('colors.destroy',$color->id)}}"
                                ...
                                <div class="current" data-kt-stepper-element="content">
                                    <div class="w-100">
                                        ...
                                        <div class="fv-row mb-10">
                                            ...
                                            <!--begin::Input-->
                                            <input type="color" class="form-control form-control-lg form-control-solid"
                                                   name="code" id="com_code" required/>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Step 1-->
                                        <div class="text-center">
...
@push('js')
    <script>
        $('#edit_app').on('show.bs.modal', function (event) {
            ...
            var com_code = button.data('com_code')
            var modal = $(this)
            ...
            modal.find('.modal-body #com_code').val(com_code);
