        ...
        <div class="toolbar" >
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <a href="#" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_create_app"
                   id="kt_toolbar_primary_button">Create User</a>
                <!--end::Button-->
            </div>
            <!--end::Container-->
        </div>
                        ...
                        <div class="table-responsive">
                            ...
                            <table id="example2"
                                ...
                                @forelse($users as $user)
                                    <tr>
                                        <td class="text-dark text-center fw-bolder text-hover-primary fs-6">{{$user->name}}</td>
                                        <td class="text-dark text-center fw-bolder text-hover-primary fs-6">{{$user->email}}</td>
                                        <td class="text-dark text-center fw-bolder text-hover-primary fs-6">{{$user->phone == null ? 'No Phone' : $user->phone}}</td>
                                ...
                                <div class="current" data-kt-stepper-element="content">
                                    <div class="w-100">
                                        ...
                                        <div class="fv-row mb-10">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input type="number" id="com_phone"
                                                   class="form-control form-control-lg form-control-solid"
                                                   name="phone" placeholder="Phone"/>
                                            <!--end::Input-->
                                        </div>
...
@push('js')
    <script>
        $('#edit_app').on('show.bs.modal', function (event) {
            ...
            var com_phone = button.data('com_phone')
            var modal = $(this)
            ...
            modal.find('.modal-body #com_phone').val(com_phone);
