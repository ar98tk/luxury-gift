            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-dark">Cities</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                ...
                <a href="#" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_create_app"
                   id="kt_toolbar_primary_button">Create City</a>
                <!--end::Button-->
            </div>
            <!--end::Container-->
        </div>
                        ...
                        <div class="table-responsive">
                            ...
                            <table id="example2"
                                ...
                                @forelse($cities as $city)
                                    <tr>
                                        <td class="text-dark text-center fw-bolder text-hover-primary fs-6">{{$city->name_en}}</td>
                                        <td class="text-dark text-center fw-bolder text-hover-primary fs-6">{{$city->name_ar}}</td>
                                        <td class="text-dark text-center fw-bolder text-hover-primary fs-6">{{$city->fee}}</td>
                                        <td class="text-center" style="display: flex; justify-content: center; ">
                                            <a data-com_id="{{ $city->id }}"
                                               data-com_name_en="{{ $city->name_en }}"
                                               data-com_name_ar="{{ $city->name_ar }}"
                                               data-com_fee="{{ $city->fee }}"
                                ...
                                <div class="current" data-kt-stepper-element="content">
                                    <div class="w-100">
                                        ...
                                        <div class="fv-row mb-10">
                                            <!--begin::Label-->
                                            <label class="d-flex align-items-center fs-5 fw-bold mb-2">
                                                <span class="required">Delivery Fee</span>
                                            </label>
                                            <!--end::Label-->
                                            <!--begin::Input-->
...
@push('js')
    <script>
        $('#edit_app').on('show.bs.modal', function (event) {
            ...
            var com_fee = button.data('com_fee')
            var modal = $(this)
            ...
            modal.find('.modal-body #com_fee').val(com_fee);
