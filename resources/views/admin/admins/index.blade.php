                        ...
                        <div class="table-responsive">
                            ...
                            <table id="example2"
                                ...
                                @forelse($admins as $admin)
                                    <tr>
                                        <td class="text-dark text-center fw-bolder text-hover-primary fs-6">{{$admin->name}}</td>
                                        <td class="text-dark text-center fw-bolder text-hover-primary fs-6">{{$admin->email}}</td>
                                        <td class="text-dark text-center fw-bolder text-hover-primary fs-6">{{$admin->created_at->format('Y-m-d')}}</td>
                                        <td class="text-center">
                                            <span class="badge @if($admin->role == 'Admin') badge-light-success @else badge-light-warning @endif">{{$admin->role}}</span>
                                        </td>
                                        <td class="text-center" style="display: flex; justify-content: center; ">
                                            <a data-com_id="{{ $admin->id }}"
                                               data-com_name="{{ $admin->name }}"
                                               data-com_email="{{ $admin->email }}"
                                               data-com_role="{{ $admin->role }}"
                                            ...
                                            <form method="POST" action="{{ route('admins.destroy', $admin->id) }}">
                                                ...
                                                <button href="{{route('admins.destroy',$admin->id)}}"
                                ...
                                <div class="current" data-kt-stepper-element="content">
                                    <div class="w-100">
                                        ...
                                        <div class="fv-row mb-10">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <select name="role" id="com_role" class="form-control">
                                                <option class="text-center" value="Admin">Admin</option>
                                                <option class="text-center" value="Moderator">Moderator</option>
                                            </select>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Step 1-->
...
@push('js')
    <script>
        $('#edit_app').on('show.bs.modal', function (event) {
            ...
            var com_role = button.data('com_role')
            var modal = $(this)
            ...
            modal.find('.modal-body #com_role').val(com_role);
