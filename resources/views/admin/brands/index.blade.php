        ...
        <div class="toolbar" >
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <a href="#" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_create_app"
                   id="kt_toolbar_primary_button">Create Brand</a>
                <!--end::Button-->
            </div>
            <!--end::Container-->
        </div>
                        ...
                        <div class="table-responsive">
                            ...
                            <table id="example2"
                                ...
                                @forelse($brands as $brand)
                                    <tr>
                                        <td class="text-dark text-center fw-bolder text-hover-primary fs-6">{{$brand->name_en}}</td>
                                        <td class="text-dark text-center fw-bolder text-hover-primary fs-6">{{$brand->name_ar}}</td>
                                        <td class="text-center" style="display: flex; justify-content: center; ">
                                            <a data-com_id="{{ $brand->id }}"
                                               data-com_name_en="{{ $brand->name_en }}"
                                               data-com_name_ar="{{ $brand->name_ar }}"
                                            ...
                                            <form method="POST" action="{{ route('brands.destroy', $brand->id) }}">
                                                ...
                                                <button href="{{route('brands.destroy',$brand->id)}}"
